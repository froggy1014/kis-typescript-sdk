 ...
 * 조건 시장 분류 코드
 */
export type ExpectedClosingPriceRequestFIDCONDMRKTDIVCODE = typeof ExpectedClosingPriceRequestFIDCONDMRKTDIVCODE[keyof typeof ExpectedClosingPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExpectedClosingPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
