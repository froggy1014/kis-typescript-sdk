 ...
 * 조건 시장 분류 코드
 */
export type IntradayChartRequestFIDCONDMRKTDIVCODE = typeof IntradayChartRequestFIDCONDMRKTDIVCODE[keyof typeof IntradayChartRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const IntradayChartRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
