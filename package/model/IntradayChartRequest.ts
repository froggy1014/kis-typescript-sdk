 ...
 */
import type { IntradayChartRequestFIDCONDMRKTDIVCODE } from './IntradayChartRequestFIDCONDMRKTDIVCODE';
import type { IntradayChartRequestFIDPWDATAINCUYN } from './IntradayChartRequestFIDPWDATAINCUYN';

export interface IntradayChartRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: IntradayChartRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드 (6자리)
   * @minLength 6
   * @maxLength 6
  ...
  /** 과거 데이터 포함 여부 */
  FID_PW_DATA_INCU_YN?: IntradayChartRequestFIDPWDATAINCUYN;
}
