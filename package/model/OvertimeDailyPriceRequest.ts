 ...
 */
import type { OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE } from './OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE';

export interface OvertimeDailyPriceRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드
   * @minLength 6
   * @maxLength 12
