 ...
 * 조건 시장 분류 코드
 */
export type OvertimeAskingPriceRequestFIDCONDMRKTDIVCODE = typeof OvertimeAskingPriceRequestFIDCONDMRKTDIVCODE[keyof typeof OvertimeAskingPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OvertimeAskingPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
