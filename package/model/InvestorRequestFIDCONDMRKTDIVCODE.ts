 ...
 * 조건 시장 분류 코드
 */
export type InvestorRequestFIDCONDMRKTDIVCODE = typeof InvestorRequestFIDCONDMRKTDIVCODE[keyof typeof InvestorRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const InvestorRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
