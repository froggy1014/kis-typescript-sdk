 ...
 */
import type { PeriodChartResponseOutput1 } from './PeriodChartResponseOutput1';
import type { PeriodChartResponseOutput2Item } from './PeriodChartResponseOutput2Item';
...
export interface PeriodChartResponse {
  ...
  msg1: string;
  /** 기간별 시세 요약 */
  output1: PeriodChartResponseOutput1;
  /** 기간별 시세 목록 */
  output2: PeriodChartResponseOutput2Item[];
}
