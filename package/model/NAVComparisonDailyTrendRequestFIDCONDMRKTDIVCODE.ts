 ...
 * 조건 시장 분류 코드
 */
export type NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE = typeof NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE[keyof typeof NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
