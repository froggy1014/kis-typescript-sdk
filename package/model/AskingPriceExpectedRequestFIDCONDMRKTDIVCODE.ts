 ...
 * 조건 시장 분류 코드
 */
export type AskingPriceExpectedRequestFIDCONDMRKTDIVCODE = typeof AskingPriceExpectedRequestFIDCONDMRKTDIVCODE[keyof typeof AskingPriceExpectedRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AskingPriceExpectedRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
