 ...
 */
import type { NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE } from './NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE';

export interface NAVComparisonDailyTrendRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: NAVComparisonDailyTrendRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드
   * @minLength 6
   * @maxLength 12
