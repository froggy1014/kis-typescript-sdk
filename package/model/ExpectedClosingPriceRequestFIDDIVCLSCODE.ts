 ...
 * 분류구분코드 (0:전체, 1:특정종목)
 */
export type ExpectedClosingPriceRequestFIDDIVCLSCODE = typeof ExpectedClosingPriceRequestFIDDIVCLSCODE[keyof typeof ExpectedClosingPriceRequestFIDDIVCLSCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExpectedClosingPriceRequestFIDDIVCLSCODE = {
  NUMBER_0: '0',
  NUMBER_1: '1',
} as const;
