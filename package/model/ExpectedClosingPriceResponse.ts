 ...
 */
import type { ExpectedClosingPriceResponseOutputItem } from './ExpectedClosingPriceResponseOutputItem';

export interface ExpectedClosingPriceResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** 예상 체결가 목록 */
  output: ExpectedClosingPriceResponseOutputItem[];
}
