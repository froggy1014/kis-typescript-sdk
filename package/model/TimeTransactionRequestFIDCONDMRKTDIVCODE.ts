 ...
 * 조건 시장 분류 코드
 */
export type TimeTransactionRequestFIDCONDMRKTDIVCODE = typeof TimeTransactionRequestFIDCONDMRKTDIVCODE[keyof typeof TimeTransactionRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TimeTransactionRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
