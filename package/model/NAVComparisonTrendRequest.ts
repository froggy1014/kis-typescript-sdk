 ...
 */
import type { NAVComparisonTrendRequestFIDCONDMRKTDIVCODE } from './NAVComparisonTrendRequestFIDCONDMRKTDIVCODE';

export interface NAVComparisonTrendRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: NAVComparisonTrendRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드
   * @minLength 6
   * @maxLength 12
