 ...
 */
import type { IntradayChartResponseOutput1 } from './IntradayChartResponseOutput1';
import type { IntradayChartResponseOutput2Item } from './IntradayChartResponseOutput2Item';
...
export interface IntradayChartResponse {
  ...
  msg1: string;
  /** 당일 분봉 요약 */
  output1: IntradayChartResponseOutput1;
  /** 당일 분봉 목록 */
  output2: IntradayChartResponseOutput2Item[];
}
