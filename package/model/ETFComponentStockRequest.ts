 ...
 */
import type { ETFComponentStockRequestFIDCONDMRKTDIVCODE } from './ETFComponentStockRequestFIDCONDMRKTDIVCODE';

export interface ETFComponentStockRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: ETFComponentStockRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드
   * @minLength 6
   * @maxLength 12
