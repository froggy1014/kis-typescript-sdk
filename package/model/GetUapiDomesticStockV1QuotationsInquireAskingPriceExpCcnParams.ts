 ...
 */
import type { GetUapiDomesticStockV1QuotationsInquireAskingPriceExpCcnFidCondMrktDivCode } from './GetUapiDomesticStockV1QuotationsInquireAskingPriceExpCcnFidCondMrktDivCode';

export type GetUapiDomesticStockV1QuotationsInquireAskingPriceExpCcnParams = {
/**
 * 조건 시장 분류 코드
 */
FID_COND_MRKT_DIV_CODE?: GetUapiDomesticStockV1QuotationsInquireAskingPriceExpCcnFidCondMrktDivCode;
/**
 * 종목코드 (6자리)
 * @minLength 6
 * @maxLength 6
