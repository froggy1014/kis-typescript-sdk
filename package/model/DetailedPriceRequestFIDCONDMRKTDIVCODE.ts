 ...
 * 조건 시장 분류 코드
 */
export type DetailedPriceRequestFIDCONDMRKTDIVCODE = typeof DetailedPriceRequestFIDCONDMRKTDIVCODE[keyof typeof DetailedPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DetailedPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
