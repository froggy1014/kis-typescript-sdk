 ...
 * 조건 시장 분류 코드
 */
export type PeriodChartRequestFIDCONDMRKTDIVCODE = typeof PeriodChartRequestFIDCONDMRKTDIVCODE[keyof typeof PeriodChartRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PeriodChartRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
