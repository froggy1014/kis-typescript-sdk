 ...
 * 조건 시장 분류 코드
 */
export type MemberRequestFIDCONDMRKTDIVCODE = typeof MemberRequestFIDCONDMRKTDIVCODE[keyof typeof MemberRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MemberRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
