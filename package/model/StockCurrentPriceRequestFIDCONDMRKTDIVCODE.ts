 ...
 * 조건 시장 분류 코드 (J: 주식)
 */
export type StockCurrentPriceRequestFIDCONDMRKTDIVCODE = typeof StockCurrentPriceRequestFIDCONDMRKTDIVCODE[keyof typeof StockCurrentPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StockCurrentPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
