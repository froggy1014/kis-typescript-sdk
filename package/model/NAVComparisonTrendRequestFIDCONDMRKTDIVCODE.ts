 ...
 * 조건 시장 분류 코드
 */
export type NAVComparisonTrendRequestFIDCONDMRKTDIVCODE = typeof NAVComparisonTrendRequestFIDCONDMRKTDIVCODE[keyof typeof NAVComparisonTrendRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NAVComparisonTrendRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
