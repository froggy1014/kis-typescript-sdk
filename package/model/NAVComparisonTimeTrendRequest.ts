 ...
 */
import type { NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE } from './NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE';

export interface NAVComparisonTimeTrendRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드
   * @minLength 6
   * @maxLength 12
