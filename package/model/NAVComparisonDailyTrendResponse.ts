 ...
 */
import type { NAVComparisonDailyTrendResponseOutputItem } from './NAVComparisonDailyTrendResponseOutputItem';

export interface NAVComparisonDailyTrendResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** NAV 비교추이 일별 목록 */
  output: NAVComparisonDailyTrendResponseOutputItem[];
}
