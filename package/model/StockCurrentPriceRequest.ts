 ...
 */
import type { StockCurrentPriceRequestFIDCONDMRKTDIVCODE } from './StockCurrentPriceRequestFIDCONDMRKTDIVCODE';

export interface StockCurrentPriceRequest {
  /** 조건 시장 분류 코드 (J: 주식) */
  FID_COND_MRKT_DIV_CODE?: StockCurrentPriceRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드 (6자리, 예: 005930)
   * @minLength 6
   * @maxLength 6
