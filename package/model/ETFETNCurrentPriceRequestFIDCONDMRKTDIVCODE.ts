 ...
 * 조건 시장 분류 코드
 */
export type ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE = typeof ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE[keyof typeof ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
