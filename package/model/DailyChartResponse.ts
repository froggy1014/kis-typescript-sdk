 ...
 */
import type { DailyChartResponseOutput1 } from './DailyChartResponseOutput1';
import type { DailyChartResponseOutput2Item } from './DailyChartResponseOutput2Item';
...
export interface DailyChartResponse {
  ...
  msg1: string;
  /** 일별 분봉 요약 */
  output1: DailyChartResponseOutput1;
  /** 일별 분봉 목록 */
  output2: DailyChartResponseOutput2Item[];
}
