 ...
 * 조건 시장 분류 코드
 */
export type DailyPriceRequestFIDCONDMRKTDIVCODE = typeof DailyPriceRequestFIDCONDMRKTDIVCODE[keyof typeof DailyPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DailyPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
