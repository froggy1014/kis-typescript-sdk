 ...
 * 조건 시장 분류 코드
 */
export type NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE = typeof NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE[keyof typeof NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NAVComparisonTimeTrendRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
