 ...
 */
import type { OvertimeDailyPriceResponseOutput1 } from './OvertimeDailyPriceResponseOutput1';
import type { OvertimeDailyPriceResponseOutput2Item } from './OvertimeDailyPriceResponseOutput2Item';

export interface OvertimeDailyPriceResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** 시간외 단일가 정보 */
  output1: OvertimeDailyPriceResponseOutput1;
  /** 시간외 일자별 주가 목록 */
  output2: OvertimeDailyPriceResponseOutput2Item[];
}
