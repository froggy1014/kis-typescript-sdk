 ...
 */
import type { OvertimeAskingPriceResponseOutput } from './OvertimeAskingPriceResponseOutput';

export interface OvertimeAskingPriceResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** 시간외 호가 정보 */
  output: OvertimeAskingPriceResponseOutput;
}
