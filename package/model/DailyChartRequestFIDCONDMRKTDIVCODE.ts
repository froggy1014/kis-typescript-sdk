 ...
 * 조건 시장 분류 코드
 */
export type DailyChartRequestFIDCONDMRKTDIVCODE = typeof DailyChartRequestFIDCONDMRKTDIVCODE[keyof typeof DailyChartRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DailyChartRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
