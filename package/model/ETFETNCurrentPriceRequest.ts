 ...
 */
import type { ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE } from './ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE';

export interface ETFETNCurrentPriceRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: ETFETNCurrentPriceRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드
   * @minLength 6
   * @maxLength 12
