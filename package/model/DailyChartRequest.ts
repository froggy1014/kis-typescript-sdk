 ...
 */
import type { DailyChartRequestFIDCONDMRKTDIVCODE } from './DailyChartRequestFIDCONDMRKTDIVCODE';
import type { DailyChartRequestFIDPERIODDIVCODE } from './DailyChartRequestFIDPERIODDIVCODE';
import type { DailyChartRequestFIDORGADJPRC } from './DailyChartRequestFIDORGADJPRC';

export interface DailyChartRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: DailyChartRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드 (6자리)
   * @minLength 6
   * @maxLength 6
  ...
  FID_PERIOD_DIV_CODE: DailyChartRequestFIDPERIODDIVCODE;
  /** 수정주가 여부 (0:수정안함, 1:수정함) */
  FID_ORG_ADJ_PRC?: DailyChartRequestFIDORGADJPRC;
}
