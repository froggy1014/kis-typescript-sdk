 ...
 */
import type { GetUapiDomesticStockV1QuotationsInquirePriceFidCondMrktDivCode } from './GetUapiDomesticStockV1QuotationsInquirePriceFidCondMrktDivCode';

export type GetUapiDomesticStockV1QuotationsInquirePriceParams = {
/**
 * 조건 시장 분류 코드 (J: 주식)
 */
FID_COND_MRKT_DIV_CODE?: GetUapiDomesticStockV1QuotationsInquirePriceFidCondMrktDivCode;
/**
 * 종목코드 (6자리, 예: 005930)
 * @minLength 6
 * @maxLength 6
