 ...
 */
import type { ETFETNCurrentPriceResponseOutput } from './ETFETNCurrentPriceResponseOutput';

export interface ETFETNCurrentPriceResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** ETF/ETN 현재가 정보 */
  output: ETFETNCurrentPriceResponseOutput;
}
