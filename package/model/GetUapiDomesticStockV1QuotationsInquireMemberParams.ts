 ...
 */
import type { GetUapiDomesticStockV1QuotationsInquireMemberFidCondMrktDivCode } from './GetUapiDomesticStockV1QuotationsInquireMemberFidCondMrktDivCode';

export type GetUapiDomesticStockV1QuotationsInquireMemberParams = {
/**
 * 조건 시장 분류 코드
 */
FID_COND_MRKT_DIV_CODE?: GetUapiDomesticStockV1QuotationsInquireMemberFidCondMrktDivCode;
/**
 * 종목코드 (6자리)
 * @minLength 6
 * @maxLength 6
