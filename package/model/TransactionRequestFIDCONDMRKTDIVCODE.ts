 ...
 * 조건 시장 분류 코드
 */
export type TransactionRequestFIDCONDMRKTDIVCODE = typeof TransactionRequestFIDCONDMRKTDIVCODE[keyof typeof TransactionRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TransactionRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
