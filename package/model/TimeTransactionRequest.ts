 ...
 */
import type { TimeTransactionRequestFIDCONDMRKTDIVCODE } from './TimeTransactionRequestFIDCONDMRKTDIVCODE';

export interface TimeTransactionRequest {
  /** 조건 시장 분류 코드 */
  FID_COND_MRKT_DIV_CODE?: TimeTransactionRequestFIDCONDMRKTDIVCODE;
  /**
   * 종목코드 (6자리)
   * @minLength 6
   * @maxLength 6
