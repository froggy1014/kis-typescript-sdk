 ...
 * 과거 데이터 포함 여부
 */
export type IntradayChartRequestFIDPWDATAINCUYN = typeof IntradayChartRequestFIDPWDATAINCUYN[keyof typeof IntradayChartRequestFIDPWDATAINCUYN];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const IntradayChartRequestFIDPWDATAINCUYN = {
  Y: 'Y',
  N: 'N',
} as const;
