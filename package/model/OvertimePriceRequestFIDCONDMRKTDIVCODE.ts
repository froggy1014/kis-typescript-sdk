 ...
 * 조건 시장 분류 코드
 */
export type OvertimePriceRequestFIDCONDMRKTDIVCODE = typeof OvertimePriceRequestFIDCONDMRKTDIVCODE[keyof typeof OvertimePriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OvertimePriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
