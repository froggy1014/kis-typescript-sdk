 ...
 * 조건 시장 분류 코드
 */
export type OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE = typeof OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE[keyof typeof OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OvertimeDailyPriceRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
