 ...
 */
import type { TimeTransactionResponseOutputItem } from './TimeTransactionResponseOutputItem';

export interface TimeTransactionResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** 시간대별 체결 내역 */
  output: TimeTransactionResponseOutputItem[];
}
