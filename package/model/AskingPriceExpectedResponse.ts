 ...
 */
import type { AskingPriceExpectedResponseOutput1 } from './AskingPriceExpectedResponseOutput1';
import type { AskingPriceExpectedResponseOutput2 } from './AskingPriceExpectedResponseOutput2';

export interface AskingPriceExpectedResponse {
  /** 성공 실패 여부 */
  rt_cd: string;
  /** 응답코드 */
  msg_cd: string;
  ...
  msg1: string;
  /** 호가 정보 */
  output1: AskingPriceExpectedResponseOutput1;
  /** 예상체결 정보 */
  output2: AskingPriceExpectedResponseOutput2;
}
