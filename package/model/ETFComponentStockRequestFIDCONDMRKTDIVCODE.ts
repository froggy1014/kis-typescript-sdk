 ...
 * 조건 시장 분류 코드
 */
export type ETFComponentStockRequestFIDCONDMRKTDIVCODE = typeof ETFComponentStockRequestFIDCONDMRKTDIVCODE[keyof typeof ETFComponentStockRequestFIDCONDMRKTDIVCODE];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ETFComponentStockRequestFIDCONDMRKTDIVCODE = {
  J: 'J',
} as const;
